      ...
      <div className="container mx-auto px-4 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          >
            <Link to="/" className="flex items-center space-x-2">
              <div className="w-10 h-10 bg-gradient-to-br from-blush-400 to-gold-400 rounded-full flex items-center justify-center">
          ...
          <motion.button
            ...
            whileHover={{ scale: 1.05 }}
            whileTap={{ scale: 0.95 }}
            className="hidden md:block bg-gradient-to-r from-blush-400 to-blush-500 text-white px-6 py-3 rounded-full font-poppins font-medium shadow-lg hover:shadow-xl transition-all duration-300"
          >
            Reservar Cita
          </motion.button>
        ...
        >
          <nav className="py-4 space-y-4 border-t border-nude-200">
            ...
            <button className="w-full bg-gradient-to-r from-blush-400 to-blush-500 text-white px-6 py-3 rounded-full font-poppins font-medium shadow-lg mt-4">
              Reservar Cita
            </button>
          </nav>
        </motion.div>
